...
Keys r4c4(KEY_DELETE,0,0,KEY_LEFT_SHIFT);	  // spaceJK
Keys r4c5(KEY_SPACE);	// space,'^');			  // fnJKh
Keys r4c6('`',0,0); // right alT
...
Keys slave_r4c4(KEY_BACKSPACE,'-',0,KEY_RIGHT_SHIFT);  // return
Keys slave_r4c5(KEY_RETURN);				  // fn
Keys slave_r4c6(KEY_RIGHT_ALT,'-',0);	 